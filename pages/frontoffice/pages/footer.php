...
<?php if ($page === 'home'): ?>
  ...
  <div style="padding: 18px 20px 8px;">
    <div class="section-header">
      <h2>Breaking News</h2>
      <span class="view-all" onclick="navigate('/frontoffice/?page=discover')">View all</span>
    </div>
  </div>

  <div class="breaking-carousel">
    <?php foreach ($breakingNews as $news): ?>
    <div class="breaking-card hover-card" onclick="navigate('/frontoffice/?page=article&slug=<?php echo urlencode($news['slug'] ?? $news['id']); ?>')">
  ...
  <div class="mob-rec-card" onclick="navigate('/frontoffice/?page=article&slug=<?php echo urlencode($rec['slug'] ?? $rec['id']); ?>')">
...
<nav class="mobile-bottom-nav">
  ...
  <button class="mob-nav-item" onclick="navigate('/frontoffice/?page=discover')">
